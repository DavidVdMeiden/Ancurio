...
if (!function_exists('be_gallery_vimeo')) {
	function be_gallery_vimeo( $url ) {
		...
		if( ! empty( $url ) ) {
			...
			return '<iframe class="be-vimeo-video gallery" src="http://player.vimeo.com/video/'.$video_id.'?api=1" id="be-vimeo-'.$video_id.'" frameborder=0 width="500" height="281" style="border: none;" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
		} else {
			return '';
		}
	}
