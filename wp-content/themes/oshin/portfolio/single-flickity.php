<?php
	...
	// 	$nav_arrows = ""
	// }
	if(isset($freeScroll_control) && $freeScroll_control == 1){
	...
	$autoslide_control = (isset($autoslide_control) && $autoslide_control == 1) ? 'data-auto-play ="'.$autoslide_duration.'"' : '';
				...
				if(!empty($attachments)) {
					...
					foreach ( $attachments as $attachment_id ) {
						...
						if($video_url) {
							...
							echo '<div class="img-wrap" '.$data_img_width. ' '.$data_img_height. ' style="margin-left: '.$gutter_width.'px;">';
							echo '<img data-flickity-lazyload="'.$data_source.'" alt="" />';
							if($overlay_flag == 1) {
								echo '<div class="img-overlay-wrap" style="background: '.$thumb_overlay_color.';"></div>';								
							}
						}
